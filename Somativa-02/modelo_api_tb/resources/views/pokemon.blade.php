...
<body class="min-h-screen bg-gradient-to-br from-slate-950 via-red-900 to-black text-white flex flex-col">
    ...
    <script>
        function buscarPokemon(event) {
            ...
            if (search) {
                ...
                if (/^\d+$/.test(search)) {
                    window.location.href = `/pokedex?id=${search}`;
                } else {
                    window.location.href = `/pokedex?name=${search}`;
                }
            }
        }
    </script>
