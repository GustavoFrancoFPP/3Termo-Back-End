                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="flex flex-col justify-between border border-gray-200 p-5 rounded-lg hover:shadow-lg transition bg-gray-50">
                            <div>
                                ...
                                <p class="text-sm text-gray-600 mb-1">
                                    <span class="font-semibold text-gray-800">Quantidade:</span> <span class="text-indigo-600 font-bold">{{ $estoque->quantidade }}</span>
                                </p>
                                <p class="text-sm text-gray-600 mb-1">
                    ...
                    @empty
                        <div class="col-span-full text-center py-12">
                            <p class="text-gray-400 text-lg italic">Nenhum estoque cadastrado até o momento.</p>
                        </div>
                    @endforelse
