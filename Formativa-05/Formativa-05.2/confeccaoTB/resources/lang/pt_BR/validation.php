...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The following language lines are used in the dashboard views.
    |
    */
    ...
    'dashboard' => [
        ...
        'total_fornecedores' => 'Total de Fornecedores',
        'valor_total_pedidos' => 'Valor Total dos Pedidos',
        'valor_total_estoque' => 'Valor Total do Estoque',
        'pedidos_recentes' => 'Pedidos Recentes',
        'pedido_numero' => 'Pedido #:numero',
        'cliente_nao_encontrado' => 'Cliente não encontrado',
        'nenhum_pedido_recente' => 'Nenhum pedido recente encontrado.',
        'alertas_estoque_baixo' => 'Alertas de Estoque Baixo',
        'produto_nao_encontrado' => 'Produto não encontrado',
        'localizacao' => 'Localização',
        'nao_informado' => 'Não informado',
        'unidades' => 'unidades',
        'estoque_baixo' => 'Estoque baixo',
        'nenhum_alerta_estoque' => 'Nenhum alerta de estoque baixo.',
        'pedidos_por_status' => 'Pedidos por Status',
        'clientes' => 'Clientes',
        'gerenciar_clientes' => 'Gerencie seus clientes',
        ...
        'comece_adicionando_primeiro_cliente' => 'Comece adicionando seu primeiro cliente!',
        'produtos' => 'Produtos',
        'gerenciar_catalogo_produtos' => 'Gerencie seu catálogo de produtos',
        ...
        'comece_adicionando_primeiro_produto' => 'Comece adicionando seu primeiro produto!',
    ],
